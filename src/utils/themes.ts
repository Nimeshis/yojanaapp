...
export const NAVBAR_LIGHT_VARIANTS: Array<Option> = [
  ...
  { value: 'navbar-ccccff navbar-light', label: 'Custom Light' }, // New color
...
export const SIDEBAR_DARK_SKINS: Array<Option> = [
  ...
  { value: 'sidebar-dark-ccccff', label: 'Custom Dark' }, // New color
...
export const SIDEBAR_LIGHT_SKINS: Array<Option> = [
  ...
  { value: 'sidebar-light-ccccff', label: 'Custom Light' }, // New color
