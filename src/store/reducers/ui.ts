...
export const uiSlice = createSlice({
  ...
  reducers: {
    ...
    toggleDarkMode: (state) => {
      ...
      if (state.darkMode) {
        state.navbarVariant = 'navbar-ccccff navbar-dark'; // Use your new custom color
        state.sidebarSkin = 'sidebar-dark-ccccff'; // Use your new custom color
      } else {
        state.navbarVariant = 'navbar-ccccff navbar-light'; // Use your new custom color
        state.sidebarSkin = 'sidebar-light-ccccff'; // Use your new custom color
      }
      if (state.darkMode) {
